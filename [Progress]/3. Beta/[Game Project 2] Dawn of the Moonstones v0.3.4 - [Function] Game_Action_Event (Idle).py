...
# Line Text
    ...
    #text_action(GameStateIG.Text_Action[8], 6, 540
    
##    text_action(GameStateIG.Text_Action[1], 5, 393)
##    text_action(GameStateIG.Text_Action[2], 5, 413.5)
##    text_action(GameStateIG.Text_Action[3], 5, 434)
##    text_action(GameStateIG.Text_Action[4], 5, 454.5)
##    text_action(GameStateIG.Text_Action[5], 5, 475)
##    text_action(GameStateIG.Text_Action[6], 5, 495.5)
##    text_action(GameStateIG.Text_Action[7], 5, 516)
##    #text_action(GameStateIG.Text_Action[8], 5, 536.5
...
def Game_Action_Event(GameState):
    if GameState == "Idle":
        if GameStateIG.Text_Line[0] == "1)" or GameStateIG.Text_Line[0] == "Move":
            pass
        if GameStateIG.Text_Line[0] == "2)" or GameStateIG.Text_Line[0] == "Potion":
            pass
        if GameStateIG.Text_Line[0] == "3)" or GameStateIG.Text_Line[0] == "Store":
            pass
        if GameStateIG.Text_Line[0] == "4)" or GameStateIG.Text_Line[0] == "Inventory":
            pass
        if GameStateIG.Text_Line[0] == "5)" or GameStateIG.Text_Line[0] == "Status":
            pass
        if GameStateIG.Text_Line[0] == "6)" or GameStateIG.Text_Line[0] == "Save":
            pass
        if GameStateIG.Text_Line[0] == "7)" or GameStateIG.Text_Line[0] == "Exit":
            pass
