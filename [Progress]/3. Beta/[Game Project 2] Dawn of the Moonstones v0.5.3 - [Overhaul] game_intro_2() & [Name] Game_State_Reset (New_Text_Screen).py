...
##            GameStateIG.Game_Event[2] = True
##
##        if GameStateIG.Text_Order == 3 and GameStateIG.Game_Event[2] == True:
##            GameStateIG.Text_Line[2] = "Where am I?"
##            GameStateIG.Text_Line[3] = "->"
##
##        if GameStateIG.Text_Order == 4 and GameStateIG.Game_Event[2] == True:
##            GameStateIG.Text_Line[3] = "Why am I inside a forest now?"
##            GameStateIG.Text_Line[4] = "->"
##
##        if GameStateIG.Text_Order == 5 and GameStateIG.Game_Event[2] == True:
##            GameStateIG.Text_Line[4] = "I should try to find a way out..."
##            GameStateIG.Text_Line[5] = "->"
##
##        if GameStateIG.Text_Order == 6 and GameStateIG.Game_Event[2] == True:
##            LvL1()
##
