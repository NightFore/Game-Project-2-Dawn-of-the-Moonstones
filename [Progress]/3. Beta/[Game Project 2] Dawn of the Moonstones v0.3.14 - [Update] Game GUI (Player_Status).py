...
# Line Text
    ...
    # Character
    text_Player_Status(GameStateIG.Player_Status[0], 656, 400)
    text_Player_Status(GameStateIG.Player_Status[1], 656, 420)
    text_Player_Status(GameStateIG.Player_Status[2], 656, 440)
    text_Player_Status(GameStateIG.Player_Status[3], 656, 460)
    text_Player_Status(GameStateIG.Player_Status[4], 656, 480)

    #Status
    text_Player_Status(GameStateIG.Player_Status[5], 656, 500)
    text_Player_Status(GameStateIG.Player_Status[6], 656, 520)
    text_Player_Status(GameStateIG.Player_Status[7], 656, 540)
    text_Player_Status(GameStateIG.Player_Status[8], 656, 560)
    text_Player_Status(GameStateIG.Player_Status[9], 656, 580)
    text_Player_Status(GameStateIG.Player_Status[10], 656, 600)
...
def Player_Status():
    # Character
    GameStateIG.Player_Status[0] = "Name:"
    GameStateIG.Player_Status[1] = "%s"             % PlayerIG.name
    GameStateIG.Player_Status[2] = "Level: %i"      % PlayerIG.level
    GameStateIG.Player_Status[3] = "Experience: %i" % PlayerIG.experience
    GameStateIG.Player_Status[4] = "Gold: %i"       % PlayerIG.gold

    # Status
    GameStateIG.Player_Status[5] = "Health: %i/%i"  % (PlayerIG.health, PlayerIG.maxhealth)
    GameStateIG.Player_Status[6] = "Strength: %i"   % PlayerIG.strength
    GameStateIG.Player_Status[7] = "Speed: %i"      % PlayerIG.speed
    GameStateIG.Player_Status[8] = "Defense: %i"    % PlayerIG.defense
    GameStateIG.Player_Status[9] = "Resistance: %i" % PlayerIG.resistance
