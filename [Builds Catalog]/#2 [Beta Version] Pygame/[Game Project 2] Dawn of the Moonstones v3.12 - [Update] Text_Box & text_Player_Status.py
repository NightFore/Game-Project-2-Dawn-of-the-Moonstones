...
#Line
    ...
    pygame.draw.line(gameDisplay, black, (627.5, 400),   (627.5, 600),   5)
    pygame.draw.line(gameDisplay, black, (797.5, 400),   (797.5, 600),   5)

    #Horizontal
    pygame.draw.line(gameDisplay, black, (0, 397.5),    (800, 397.5), 5)
    pygame.draw.line(gameDisplay, black, (625, 472.5),  (800, 472.5), 5)
    pygame.draw.line(gameDisplay, black, (150, 572.5),  (625, 572.5), 5)
    pygame.draw.line(gameDisplay, black, (0, 597.5),    (800, 597.5), 5)
    
#Rectangle
    pygame.draw.rect(gameDisplay, game_ui_color, (5, 400, 145, 195))
    
    pygame.draw.rect(gameDisplay, game_ui_color, (155, 400, 470, 170))
    pygame.draw.rect(gameDisplay, game_ui_color, (155, 575, 470, 20))

    pygame.draw.rect(gameDisplay, game_ui_color, (630, 400, 165, 70))
    pygame.draw.rect(gameDisplay, game_ui_color, (630, 475, 165, 120))
...
# Line Text
    ...
    text_action(GameStateIG.Text_Action[2], 6, 420)
    text_action(GameStateIG.Text_Action[3], 6, 440)
    text_action(GameStateIG.Text_Action[4], 6, 460)
    text_action(GameStateIG.Text_Action[5], 6, 480)
    text_action(GameStateIG.Text_Action[6], 6, 500)
    text_action(GameStateIG.Text_Action[7], 6, 520)

    # Character
    text_Player_Status(GameStateIG.Player_Status[0], 630, 400)
    text_Player_Status(GameStateIG.Player_Status[1], 630, 420)
    text_Player_Status(GameStateIG.Player_Status[2], 630, 440)
    text_Player_Status(GameStateIG.Player_Status[3], 630, 460)

    #Status
    text_Player_Status(GameStateIG.Player_Status[4], 630, 480)
    text_Player_Status(GameStateIG.Player_Status[5], 630, 500)
    text_Player_Status(GameStateIG.Player_Status[6], 630, 520)
    text_Player_Status(GameStateIG.Player_Status[7], 630, 540)
    text_Player_Status(GameStateIG.Player_Status[8], 630, 560)
...
def text_line_order():
    ...
    while GameStateIG.Line_x != GameStateIG.Order_Text:
        GameStateIG.Line_x += 1

    if GameStateIG.Line_x == GameStateIG.Order_Text :
        ...
        GameStateIG.Order_Text += 1

        if GameStateIG.Order_Text > GameStateIG.Maximal:
            GameStateIG.Line_x      = GameStateIG.Minimal
            GameStateIG.Order_Text  = GameStateIG.Minimal
...
# Game Events :
        if GameStateIG.Game_Event[0] == False:
            ...
            GameStateIG.Order_Text = 2
            GameStateIG.Game_Event[0] = True


        if GameStateIG.Text_Line[2] == "" and GameStateIG.Order_Text == 3 or GameStateIG.Game_Event[1] == True:
            if GameStateIG.Game_Event[1] == False:
                GameStateIG.Text_Line[2] = "That doesn't seem like a real name!"
                GameStateIG.Text_Line[3] = "->"
                GameStateIG.Order_Text == 3
                GameStateIG.Game_Event[1] = True
            
            elif GameStateIG.Order_Text == 4 or GameStateIG.Game_Event[2] == True:
                if GameStateIG.Game_Event[2] == False:    
                    GameStateIG.Text_Line[3] = "Please, tell me your name!"
                    GameStateIG.Text_Line[4] = "->"
                    GameStateIG.Order_Text = 4
                    GameStateIG.Game_Event[2] = True

                elif GameStateIG.Text_Line[4] != "->" and GameStateIG.Text_Line[4] != "" and GameStateIG.Order_Text == 5:
                    global PlayerIG
                    PlayerIG = Player(GameStateIG.Text_Line[4])
                    game_intro_2()
                    
                elif GameStateIG.Text_Line[4] == "" and GameStateIG.Order_Text == 5:
                    GameStateIG.Text_Line[4] = "->"
                    GameStateIG.Order_Text = 4
                    
                    
        elif GameStateIG.Text_Line[2] != "" and GameStateIG.Order_Text == 3:
            PlayerIG = Player(GameStateIG.Text_Line[2])
            game_intro_2()
...
# Game Story
        ...
        if GameStateIG.Order_Text == 3 and GameStateIG.Game_Event[1] == True:
            GameStateIG.Text_Line[2] = "You have to wake up!"
            GameStateIG.Text_Line[3] = "->"

        if GameStateIG.Order_Text == 4 and GameStateIG.Game_Event[1] == True:
            GameStateIG.Text_Line[3] = "I will watch over you, but right now..."
            GameStateIG.Text_Line[4] = "->"

        if GameStateIG.Order_Text == 5 and GameStateIG.Game_Event[1] == True:
            GameStateIG.Text_Line[4] = "You have a long road awaiting you..."
            GameStateIG.Text_Line[5] = "->"
            
        #Text Screen 2
        if GameStateIG.Order_Text == 6 and GameStateIG.Game_Event[1] == True:
            GameStateIG.Text_Line=["","","","","","","","",""]
        ...
        if GameStateIG.Order_Text == 3 and GameStateIG.Game_Event[2] == True:
            GameStateIG.Text_Line[2] = "Where am I?"
            GameStateIG.Text_Line[3] = "->"

        if GameStateIG.Order_Text == 4 and GameStateIG.Game_Event[2] == True:
            GameStateIG.Text_Line[3] = "Why am I inside a forest now?"
            GameStateIG.Text_Line[4] = "->"

        if GameStateIG.Order_Text == 5 and GameStateIG.Game_Event[2] == True:
...
def Player_Status():
    # Character
    GameStateIG.Player_Status[0] = "Name: %s"       % PlayerIG.name
    GameStateIG.Player_Status[1] = "Level: %i"      % PlayerIG.level
    GameStateIG.Player_Status[2] = "Exp: %i"        % PlayerIG.experience
    GameStateIG.Player_Status[3] = "Gold: %i"       % PlayerIG.gold

    # Status
    GameStateIG.Player_Status[4] = "Weap: %s"       % PlayerIG.curweap
    GameStateIG.Player_Status[5] = "Str: %i"        % PlayerIG.strength
    GameStateIG.Player_Status[6] = "Spd: %i"        % PlayerIG.speed
    GameStateIG.Player_Status[7] = "Def: %i"        % PlayerIG.defense
    GameStateIG.Player_Status[8] = "Res: %i"        % PlayerIG.resistance
