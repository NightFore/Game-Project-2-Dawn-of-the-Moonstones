...
def Equip(Category):
    ...
    # Text Input
        if GameStateIG.Game_Event[5] == False:
            ...
            if GameStateIG.Text_Order == 2 and GameStateIG.Text_Line[0] not in PlayerIG.weap and GameStateIG.Text_Line[0] != PlayerIG.curweap and GameStateIG.Text_Line[0] != "Cancel" :
                GameStateIG.Text_Line[GameStateIG.Variable_x] = ""
            ...
            # Equip Same Weapon
            elif GameStateIG.Text_Line[0] == PlayerIG.curweap:
    ...
    # Loop & Return
        ...
        elif GameStateIG.Text_Order == 3 or GameStateIG.Text_Order == 4:
            GameStateIG.Game_Event[4] = False
...
##    print("You received %i damage!" % ennemy.attack)
##    if PlayerIG.health <= 0:
##        death()
##        
##    option = input(" ")
