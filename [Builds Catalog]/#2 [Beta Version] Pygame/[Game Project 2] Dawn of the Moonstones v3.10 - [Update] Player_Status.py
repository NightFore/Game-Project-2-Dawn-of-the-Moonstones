...
def Player_Status():
    ...
    GameStateIG.Player_Status[2] = "Experience: %i"     % PlayerIG.experience
    GameStateIG.Player_Status[3] = "Gold: %i"           % PlayerIG.gold

    # Status
    GameStateIG.Player_Status[4] = "Strength: %i"       % PlayerIG.strength
    GameStateIG.Player_Status[5] = "Speed: %i"          % PlayerIG.speed
    GameStateIG.Player_Status[6] = "Defense: %i"        % PlayerIG.defense
    GameStateIG.Player_Status[7] = "Resistance: %i"     % PlayerIG.resistance
