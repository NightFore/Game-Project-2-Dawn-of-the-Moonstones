...
#Button
def button(msg,x,y,w,h,ic,ac,keys,action=None):
...
def main_menu():
    ...
    while not gameExit:
        ...
        button("Start", display_width/2-display_width/12, display_height*0.45, display_width/6,50, green, bright_green, keys, game_intro1)
        button("Load",  display_width/2-display_width/12, display_height*0.60, display_width/6,50, red, bright_red, keys, game_load)
        button("Exit",  display_width/2-display_width/12, display_height*0.75, display_width/6,50, red, bright_red, keys, quit_game)
