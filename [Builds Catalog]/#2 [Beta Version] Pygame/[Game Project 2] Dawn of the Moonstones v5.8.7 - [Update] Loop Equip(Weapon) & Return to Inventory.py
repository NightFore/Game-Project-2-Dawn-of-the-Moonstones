...
# Game Core
        text_box(events)
        Player_Status()
        print(GameStateIG.Game_Event[1])
...
def Equip(Category):
    ...
    # List of Weapons
        if GameStateIG.Text_Order == 0:
            ...
            for weapon in PlayerIG.weap:
                GameStateIG.Text_Line[GameStateIG.Variable_x] = "%s" % PlayerIG.weap
    ...
    # Text Input
        # Equip New Weapon
        if GameStateIG.Text_Line[0] == PlayerIG.weap:
            PlayerIG.curweap = GameStateIG.Text_Line[0]
            GameStateIG.Text_Line[1] = "You have equipped %s!" % GameStateIG.Text_Line[0]
            GameStateIG.Text_Line[2] = "->"
            GameStateIG.Text_Order = 2
            # Return to Inventory
        ...
        # Return to Inventory
        if GameStateIG.Text_Line[0] == "Cancel" or GameStateIG.Game_Event[5] == True:
            GameStateIG.State = "Inventory"
            GameStateIG.Game_Event[3] = False
            GameStateIG.Game_Event[5] = False
