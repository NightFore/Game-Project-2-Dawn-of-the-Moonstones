...
#Rectangle
    pygame.draw.rect(gameDisplay, blue, (5, 400, 145, 195))
    
    pygame.draw.rect(gameDisplay, blue, (155, 400, 495, 170))
    pygame.draw.rect(gameDisplay, blue, (155, 575, 495, 20))

    pygame.draw.rect(gameDisplay, blue, (655, 400, 140, 70))
    pygame.draw.rect(gameDisplay, blue, (655, 475, 140, 120))
