...
def Player_Status():
    GameStateIG.Player_Status[0] == PlayerIG.name
    GameStateIG.Player_Status[1] == PlayerIG.level
    GameStateIG.Player_Status[2] == PlayerIG.experience
    GameStateIG.Player_Status[3] == PlayerIG.gold
    
    GameStateIG.Player_Status[4] == PlayerIG.strength
    GameStateIG.Player_Status[5] == PlayerIG.speed
    GameStateIG.Player_Status[6] == PlayerIG.defense
    GameStateIG.Player_Status[7] == PlayerIG.resistance
