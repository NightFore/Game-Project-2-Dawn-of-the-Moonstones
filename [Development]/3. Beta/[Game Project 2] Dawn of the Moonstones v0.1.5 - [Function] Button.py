...
# Activations Conditions
    ...
    textSurf, textRect = text_button(msg, smallText)
...
def main_menu():
    ...
    while not gameExit:
        ...
        button("Start", display_width/2-display_width/16, display_height*0.45-display_height/32, display_width/8, display_height/12, green, red, game_intro1)
        button("Load",  display_width/2-display_width/16, display_height*0.60-display_height/32, display_width/8, display_height/12, green, red, game_load)
        button("Exit",  display_width/2-display_width/16, display_height*0.75-display_height/32, display_width/8, display_height/12, green, red, quit_game)
