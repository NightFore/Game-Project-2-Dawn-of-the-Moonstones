...
class GameState:
    def __init__(self, name):
        ...
        self.Text_Order = 1
        self.Text_Action =  ["", "", "", "", "", "", "", "", ""]
        self.Game_Event = [False,False,False,False,False]
...
def Game_State_Reset():
    ...
    GameStateIG.Game_Event = [False,False,False,False,False]
...
def Game_Action_Choice(GameState):
    ...
    if GameState == ("Inventory"):
        ...
        if GameStateIG.Text_Line[0] == "3" or GameStateIG.Text_Line[0] == "3)" or GameStateIG.Text_Line[0] == "Equip Accessory":
            GameStateIG.Text_Line[0] = ""
            GameStateIG.Text_Order = 2
            GameStateIG.Game_State = "Equip Accessory"
            GameStateIG.Game_Event[3] = True
            Equip("Accessory")
        ...
        if GameStateIG.Text_Line[0] == "4" or GameStateIG.Text_Line[0] == "4)" or GameStateIG.Text_Line[0] == "Check Items":
            GameStateIG.Text_Line[0] = ""
            GameStateIG.Text_Order = 2
            GameStateIG.Game_State = "Check Items"
            GameStateIG.Game_Event[3] = True
            pass
            #Items()
...
# Game Core
    ...
    # Game Action Choice
        ...
        if GameStateIG.Game_Event[1] == True and GameStateIG.State == "Move":
            ...
            # Fight State
        if GameStateIG.Game_Event[2] == True and GameStateIG.State == "Move":
            fight()
        ...
        # 4) Inventory
        if GameStateIG.Game_Event[1] == True and GameStateIG.State == "Inventory" or GameStateIG.Game_Event[3] == True:
            if GameStateIG.Game_Event[3] == False:
                Inventory()
                
            elif GameStateIG.Game_Event[3] == True:
...
def Equip(Category): 
    ...
    if Category == "Weapon":
        # List of Actions
        if GameStateIG.Text_Order == 0 and GameStateIG.Game_Event[3] == True:
            GameStateIG.Text_Line[1] = "What should I Equip?"
            for weapon in PlayerIG.weap:
                GameStateIG.Text_Line[x] = "%s" % PlayerIG.weap
                x += 1

        #Loop
        if GameStateIG.Text_Order == 1 and GameStateiG.Game_Event[3] == True:
