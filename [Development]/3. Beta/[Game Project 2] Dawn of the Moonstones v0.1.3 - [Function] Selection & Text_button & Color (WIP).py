...
def main_menu():
    ...
    selection(0, "Start", 150,450,100,50, green, bright_green, keys, game_intro1)
    selection(2, "Load", 550,450,100,50, red, bright_red, keys, game_load)
    selection(3, "Exit", 550,450,100,50, red, bright_red, keys, quit_game)
