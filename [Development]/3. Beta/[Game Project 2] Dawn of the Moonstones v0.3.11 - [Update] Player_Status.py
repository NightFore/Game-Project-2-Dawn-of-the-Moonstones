...
# Line Text
    ...
    # Character
    text_action(GameStateIG.Player_Status[0], 651, 400)
    text_action(GameStateIG.Player_Status[1], 651, 420)
    text_action(GameStateIG.Player_Status[2], 651, 440)
    text_action(GameStateIG.Player_Status[3], 651, 460)

    #Status
    text_action(GameStateIG.Player_Status[4], 651, 480)
    text_action(GameStateIG.Player_Status[5], 651, 500)
    text_action(GameStateIG.Player_Status[6], 651, 520)
    text_action(GameStateIG.Player_Status[7], 651, 540)
    text_action(GameStateIG.Player_Status[8], 651, 560)
