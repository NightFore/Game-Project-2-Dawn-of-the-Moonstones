...
# Drinking Potion
    ...
    # Fight State
            ...
            # Ennemy Phase
            if GameStateIG.Text_Order == 3:
                GameStateIG.Text_Line[GameStateIG.Variable_x+3] = ""
                GameStateIG.Text_Line[GameStateIG.Variable_x+4] = "%s attacks!" % ennemy.name
                GameStateIG.Text_Line[GameStateIG.Variable_x+5] = "->"
                
            elif GameStateIG.Text_Order == 4:
                GameStateIG.Text_Line[GameStateIG.Variable_x+5] = "You received %i damage!" % ennemy.attack
                GameStateIG.Text_Line[GameStateIG.Variable_x+6] = "->"
