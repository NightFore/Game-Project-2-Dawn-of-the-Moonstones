...
# Game Story
        ...
        if GameStateIG.Order_Text == 6 and GameStateIG.Game_Event[2] == True:
            LvL1()
...
def attack():
    ...
    if GameStateIG.Game_Fight_Attack[0] == False:
    ...
    elif GameStateIG.Order_Text == 2:
        GameStateIG.Text_Line[1] ="%s attacks!" % PlayerIG.name
        GameStateIG.Text_Line[2] = "->"

    elif GameStateIG.Order_Text == 3:
        ...
        #Win Condition
    elif GameStateIG.Order_Text == 4 :
        if ennemy.health <= 0:
            win()
        else:
            GameStateIG.Order_Text = 5



    #Ennemy Phase
    elif GameStateIG.Order_Text == 5:

        GameStateIG.Text_Line[4] = "%s attacks!" % ennemy.name
        GameStateIG.Text_Line[5] = "->"

    elif GameStateIG.Order_Text == 6:
        ...
        # Death Conditon
    elif GameStateIG.Order_Text == 7 :
        if PlayerIG.health <= 0:
            death()
        else:
            GameStateIG.Order_Text = 8



    # Attack Phase End
    elif GameStateIG.Order_Text == 8:
