...
# Line Text
    text_ui(Text_Line[1], 157.5, 390)
    text_ui(Text_Line[2], 157.5, 410)
    text_ui(Text_Line[3], 157.5, 430)
    text_ui(Text_Line[4], 157.5, 450)
    text_ui(Text_Line[5], 157.5, 470)
    text_ui(Text_Line[6], 157.5, 490)
    text_ui(Text_Line[7], 157.5, 510)
    text_ui(Text_Line[8], 157.5, 530)
